...
2. Creator and Maintainer: Kenta Nakai, Institue of Molecular and Cellular Biology, Osaka, University, nakai@imcb.osaka-u.ac.jp http://www.imcb.osaka-u.ac.jp/nakai/psort.html
Donor: Paul Horton (paulh@cs.berkeley.edu)
Date:  September, 1996
See also: yeast database


3. The references below describe a predecessor to this dataset and its development. They also give results (not cross-validated) for classification by a rule-based expert system with that version of the dataset.
...
5. Number of Instances:  336 for the E.coli dataset 


6. Number of Attributes. for E.coli dataset:  8 ( 7 predictive, 1 name )
